...
## HTML 슬라이드 구조 — `slides` 모드 (p41/42/43/45)
...
## HTML 한 페이지 구조 — `landing` 모드 (p70 웹사이트·랜딩페이지)
...
## HTML 한 페이지 구조 — `direct` 모드 (p73 웹사이트 제작)
...
---
*Generated by /roasting v0.3 — case {case_id} {folio}*
```
